...
{
    public class Catalog2LatestJob : BackgroundService
    {
        ...
        private readonly ILogger<Catalog2LatestJob> _logger;

        public Catalog2LatestJob(
            ...
            ILogger<Catalog2LatestJob> logger)
        {
            _producer = processor;
            _worker = worker;
